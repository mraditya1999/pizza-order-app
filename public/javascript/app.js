...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('/admin/orders', {
    ...
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("739cbc78_0", err)));
  });
  ...
  function generateMarkup(orders) {
    return orders.map(function (order) {
      var _console2;
      /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("739cbc78_1", _typeof(order.customerId))));
